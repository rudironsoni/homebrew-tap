...
# Horca release exists on rudironsoni/orca-builds. Fill them manually once
...
cask "horca" do
  ...
  url "https://github.com/rudironsoni/orca-builds/releases/download/v#{version}/horca-macos-#{arch}.dmg"
  name "Horca"
